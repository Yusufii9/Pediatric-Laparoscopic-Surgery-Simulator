...
class GestureDetector:
    ...
    def process_video(self):
        ...
        print(f"Start Time in sec: {time_start}")
        ...
        time_end = time.time()
        print(f"End Time in seconds: {time_end}")

        time_total = round(time_end - time_start)
        print(f"Total Time in seconds: {time_total}")

        time_min = round(time_total / 60)
        print(f"Total Time in minutes: {time_min}")
...
if __name__ == "__main__":
    gesture_detector = GestureDetector(
        model_name=r"C:\Users\hudasheikh\Desktop\Pediatric-Laparoscopic-Surgery-Simulator-main\myLapSim\Esra's Model\Gesture Reconigtion\my_ssd_mobnet",
        video_path=r"C:\Users\hudasheikh\Desktop\Pediatric-Laparoscopic-Surgery-Simulator-main\myLapSim\Esra's Model\Gesture Reconigtion\Atallah.mp4",
        labelmap_path='/Users/hudasheikh/Gesture Reconigtion/annotations/label_map.pbtxt',
        pipeline_config_path='/Users/hudasheikh/Gesture Reconigtion/my_ssd_mobnet/export/pipeline.config',
        checkpoint_path='/Users/hudasheikh/Gesture Reconigtion/my_ssd_mobnet',
        csv_path=r"C:\Users\hudasheikh\Desktop\Pediatric-Laparoscopic-Surgery-Simulator-main\myLapSim\Esra's Model\Gesture Reconigtion\gesture_detection.csv"
    )
