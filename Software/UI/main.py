...
class Application(tk.Tk):
    ...
    def stream(self):
        ...
        self.canvas.create_text(
            ...
            font=('Courier', 18), fill='white', tags=("overlay","text",)
        )
    ...
    def main(self):
            ...
            def display_warning(self, frame):
                ...
                if cur_time - self.warning_time[0] < 1:
                    cv2.putText(frame, "Too much force!", (500, 700), self.font, 1, (255, 215, 5), 2)
                if cur_time - self.warning_time[1] < 1:
                    cv2.putText(frame, "Slow left pitch acc.", (25, 650), self.font, 1, (255, 215, 5), 2)
                if cur_time - self.warning_time[2] < 1:
                    cv2.putText(frame, "Slow left yaw acc.", (25, 700), self.font, 1, (255, 215, 5), 2)
                if cur_time - self.warning_time[3] < 1:
                    cv2.putText(frame, "Slow right pitch acc.", (925, 650), self.font, 1, (255, 215, 5), 2)
                ...
                if cur_time - self.warning_time[5] < 1:
                    cv2.putText(frame, "Slow left surge acc.", (25, 600), self.font, 1, (255, 215, 5), 2)
                if cur_time - self.warning_time[6] < 1:
                    cv2.putText(frame, "Slow left rotation acc.", (25, 550), self.font, 1, (255, 215, 5), 2)
