...
def get_next_filename():
    ...
    files = [
        ...
        if f.startswith("CleanedSensorData_") and f.endswith(".csv")
    ]
...
def cleaning_sensor_data():
    ...
    for i in cleaned_data:
        ...
        L_motion.append(i[26])
        R_motion.append(i[27])
    ...
    if not temp_df.empty:
        ...
        messagebox.showinfo(
            title="Success", message="Sensor Data Have Been Processed and Saved"
        )
    else:
