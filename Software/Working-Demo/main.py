...
class Application(tk.Tk):
    ...
    def run_data_processing(self):
        ...
        def background_task():
            try:
                self.analysis = Task1PerformanceAnalyzer('Video10_Reference_Seg1.csv', 'Video9_user_Seg1.csv','Video10.mp4', 'Video9.mp4')
    ...
    def feedback_menu(self):
        ...
        self.add_button('Video Playback', self.destroy, (self.screen_height/3 + 250))
    ...
    def peg_sub_task_video(self):
        ...
        self.add_button('Subtask 1', self.video_test, (self.screen_height/3 + 150))
...
class GUI(object):
    ...
    def main(self):
            ...
            def check_sensor_warnings(self, frame, data, max_force):
                ...
                if len(data.split("|")) == 10:     # Make sure array of proper length
